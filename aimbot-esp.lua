...
_G.Aimbot_Settings={
    ...
    Fov=75,--0-inf  aimbot circle size
...
coroutine.wrap(function()
    while wait(.2)do
        pcall(function()
            for _,v in pairs(GetEnemys())do
                for _,c in pairs(v.Body:GetChildren())do
                    local part=c
                    ...
                    a.Adornee=part
                    a.ZIndex=0
                    a.Color3=Color3.new(50/255,150/255,1)
                    coroutine.wrap(function()
                        wait(.3)
                        a:Destroy()
                    end)()
                    local a=Instance.new("BoxHandleAdornment")
                    a.Size=part.Size+Vector3.new(.5,.5,.5)
                    a.Parent=game.CoreGui
                    a.AlwaysOnTop=false
                    a.Adornee=part
                    a.ZIndex=0
                    a.Color3=Color3.new(1,0,175/255)
                    coroutine.wrap(function()
                        wait(.3)
                        a:Destroy()
                    end)()
...
--made by The3Bakers#4565
--discord link https://discord.gg/vQQqcgBWCG
_G.HitBoxPart="Chest"--All,LeftHand,Abdomen,RightLeg,Hips,RightFoot,LeftArm,LeftForearm,RightForearm,RightForeleg,RightHand,Chest,RightArm,Neck,Head,LeftForeleg,LeftLeg,LeftFoot
_G.HitBoxSize=7--0-50
_G.HitBoxColor=Color3.fromRGB(255,0,0)
_G.HitBoxTransparency=0--0-1 (0 visible 1 invisible)
_G.HitBoxMaterial="ForceField"--Plastic,Wood,Slate,Concrete,CorrodedMetal,DiamondPlaye,Foil,Grass,Ice,Marble,Granite,Brick,Pebble,Sand,Fabric,SmoothPlastic,Metal,WoodPlanks,Cobblestone,Neon,Glass,ForceField
